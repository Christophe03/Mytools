...
export class AccessoireComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.accessoireservice.ListeAccessoires().subscribe((data:any)=>{
      this.list = data;
  ...
  deleteitem(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.accessoireservice.supprimerAccessoire(id).subscribe(res=>{
        Swal.fire(
          'Supprimer!',
...
saveAcc(f:NgForm){
  ...
  this.accessoireservice.ajouterAccessoire(f.value).subscribe((data:any)=>{
...
toEdit(event:any){
  ...
  this.accessoireservice.afficherAccessoireById(event).subscribe((data:any)=>{
    console.log("get accessoire", data);
    this.getAcce = data
    this.edit();
...
savemodif(abba:NgForm){ 
  ...
  this.alertAngular();
this.accessoireservice.modifierAccessoire(abba.value,this.getAcce.id).subscribe((data:any)=>{ 
